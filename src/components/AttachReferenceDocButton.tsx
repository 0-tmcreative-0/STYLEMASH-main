  ...
  return (
    <div>
      <button
        ...
        className="w-full rounded-md bg-slate-600 px-3 py-1.5 text-xs font-medium text-white enabled:hover:bg-slate-700 disabled:cursor-not-allowed disabled:bg-slate-300"
      >
