...
6. Prefer merging straight into a specific style? Click that style's row in **New Styles** to mark it as the target, select entries on the left, then click **Merge N selected here** on the target row — no dialog needed.
